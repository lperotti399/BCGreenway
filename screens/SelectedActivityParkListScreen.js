...
function SelectedActivityParkListScreen({
  onPickPark,
  onPickNews,
  onPickAbout,
  userSingleActivity,
  ...
  // .filter((park) => park === userSingleActivity)
  ...
  function resetSingleActivityHandler() {
    resetSingleActivity("");
    onPickActivities(1);
    resetPark("");
  }

  function pickPlacesIconHandler() {
    resetSingleActivity("");
  }
  return (
          ...
          data={newPARKS
            .filter((park) =>
              park.activities.some(
                (activity) => activity === userSingleActivity
              )
            )
        ...
        <View style={[styles.navBarContainer]}>
          ...
          <View style={[styles.activitiesContainer]}>
            <Pressable
              ...
              onPress={resetSingleActivityHandler}
            >
              <Image
...
export default SelectedActivityParkListScreen;
